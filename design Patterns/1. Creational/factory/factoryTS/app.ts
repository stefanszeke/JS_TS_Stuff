...
import { Admin, Person, PersonFactory1, PersonFactory2, PersonFactory3, NewPersonFactory } from "./person";
...
let AdamTheGuest = NewPersonFactory.createGuest('Adam');
let PeterTheUser = NewPersonFactory.createUser('Peter');
let JamesTheAdmin = NewPersonFactory.createAdmin('James');
